		...
		<section class="multiwitamina">
			<div class="row">
				<div class="col-sm-12 col-md-6">
					<figure class="figure">
						<img src="photos/omega.jpg" class="img-fluid" alt="Multiwitamina"  width="450">
							<figcaption> Omega-3 to najważniejsze z tzw. Niezbędnych Nienasyconych Kwasów Tłuszczowych (NNKT). Pełnią wiele ważnych funkcji w naszym organizmie. Oprócz tych budulcowych, zajmują się również transportem i metabolizmem cholesterolu i tłuszczy.  </figcaption>
					</figure> 
				</div>
