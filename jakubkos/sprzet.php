	...
	<div class="row">
		<div class="col-sm-12 col-md-6 col-lg-4">
			<figure class="figure">
				...
				<figcaption>   Obciążenie 100kg   900 zł     </figcaption>
			</figure>
		</div>
		
		<div class="col-sm-12 col-md-6 col-lg-4">
			<figure class="figure">
				<a href="sztangielka.php"><img src="photos/sztangielka.jpg" class="img-fluid" alt="Sztangielka"> </a>
				<figcaption>   Sztangielka 25kg 150 zł    </figcaption>
			</figure>
		</div>
		
		<div class="col-sm-12 col-md-6 col-lg-4">
			<figure class="figure">
				<a href="mata.php"><img src="photos/mata.jpg" alt="Omega 3" class="img-fluid"> </a>
				<figcaption> Mata do ćwiczeń 40 zł </figcaption>
			</figure>
		</div>
	</div>
	</section>
