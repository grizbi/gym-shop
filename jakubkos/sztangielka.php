...
<header>
	...
	<div class="row">
		...
		<figure class="figure">
		<img src="photos/sztangielka.jpg" class="img-fluid" alt="Multiwitamina"  width="450">
			<figcaption> Nasze obciążenia olimpijskie zostały zaprojektowane z myślą o maksymalnym komforcie użytkowania zarówno dla zawodowców jak i użytkowników domowych. Znajdują zastosowanie w profesjonalnych siłowniach, salach fitness, crossfit oraz w warunkach domowych.  </figcaption>
		</figure> </div>
		<div class="col-sm-12 col-md-6 kupteraz">  <a href="#" class="text-decoration-none text-light"><h4 class="font-weight-bold text-uppercase pb-2 pr-2 pt-2 pl-2 mt-5 mb-2 bg-footercolor"> KUP TERAZ <br> 150 ZŁ </h4>  </a> </div>
	</div>
	</section>
