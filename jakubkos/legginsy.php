	...
	<section class="multiwitamina">
		<div class="row">
			<div class="col-sm-12 col-md-6">
				<figure class="figure">
					<img src="photos/legginsy.jpg" class="img-fluid" alt="Multiwitamina"  width="450">
						<figcaption> Legginsy to dobry wybór w gorące dni. Sprawdzą się również przez cały rok na zajęciach indoorowych. Możesz w nich swobodnie biegać, tańczyć, ćwiczyć na siłowni czy podróżować.  </figcaption>
				</figure> </div>
			<div class="col-sm-12 col-md-6  kupteraz">  <a href="#" class="text-decoration-none text-light"><h4 class="font-weight-bold text-uppercase pb-2 pr-2 pt-2 pl-2 mt-5 mb-2 bg-footercolor"> KUP TERAZ <br> 69 ZŁ </h4>  </a> </div>
