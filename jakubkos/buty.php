...
<header>
	...
	<div class="row">
		<div class="col-sm-12 col-md-6">
			<figure class="figure">
				<img src="photos/buty.jpg" class="img-fluid" alt="Multiwitamina"  width="450">
					<figcaption> Buty sportowe - dla ludzi aktywnych, ceniących sobie komfort i styl. Sprawdź ofertę w sklepie internetowym i wybierz model dla Ciebie.  </figcaption>
			</figure> </div>
		<div class="col-sm-12 col-md-6  kupteraz">  <a href="#" class="text-decoration-none text-light"><h4 class="font-weight-bold text-uppercase pb-2 pr-2 pt-2 pl-2 mt-5 mb-2 bg-footercolor"> KUP TERAZ <br> 199 ZŁ </h4>  </a> </div>
