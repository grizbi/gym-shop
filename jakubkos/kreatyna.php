	...
	<section class="multiwitamina">
		<div class="row">
			<div class="col-sm-12 col-md-6">
				<figure class="figure">
					<img src="photos/kreatyna.jpg" class="img-fluid" alt="Multiwitamina"  width="450">
						<figcaption> Kreatyna, czyli kwas β-metyloguanidynooctowy, występuje naturalnie w naszych organizmach. Składa się z trzech aminokwasów: argininy, glicyny i metioniny. Organizm syntetyzuje kreatynę w wątrobie, nerkach i trzustce, w trakcie przemiany materii.  </figcaption>
				</figure> </div>
			<div class="col-sm-12 col-md-6  kupteraz">  <a href="#" class="text-decoration-none text-light"><h4 class="font-weight-bold text-uppercase pb-2 pr-2 pt-2 pl-2 mt-5 mb-2 bg-footercolor"> KUP TERAZ <br> 35 ZŁ </h4>  </a> </div>
