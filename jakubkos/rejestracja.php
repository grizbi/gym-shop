...
<div class="col-12 col-md-6 offset-md-3 text-center">
	<form action="zarejestruj.php" method="post">
		...
		<?php
			...
			{
				echo '<div style="color:red" class="error">'.$_SESSION['e_login'].'</div>';
				unset($_SESSION['e_login']);
			}
		
		?>
		<input type="password" placeholder="hasło" onfocus="this.placeholder=''" onblur="this.placeholder='hasło'" name="haslo"/><br> <br>
		<?php
		if(isset($_SESSION['e_haslo']))
			{
				echo '<div style="color:red" class="error">'.$_SESSION['e_haslo'].'</div>';
				unset($_SESSION['e_haslo']);
			}
		?>
		<input type="password" placeholder="powtórz hasło" onfocus="this.placeholder=''" onblur="this.placeholder='powtórz hasło'" name="haslo1"/><br> <br>
		<input type="text" placeholder="email" onfocus="this.placeholder=''" onblur="this.placeholder='email'" name="email"/><br> <br>
		<?php
			if(isset($_SESSION['e_email']))
			{
				echo '<div style="color:red" class="error">'.$_SESSION['e_email'].'</div>';
		...
		<?php
		if((isset($_SESSION['zarejestruj'])) && ($_SESSION['zarejestruj']==true))
		{
			echo '<div class="register">Udana rejestracja!</div>';
			unset($_SESSION['zarejestruj']);
