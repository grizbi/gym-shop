...
<header>
	...
	<div class="row">
		<div class="col-sm-12 col-md-6">
			<figure class="figure">
				<img src="photos/multiwitamina.jpg" class="img-fluid" alt="Multiwitamina"  width="450">
					<figcaption> Multiwitamina to dawka witamin i minerałów najwyższej jakości, która została skomponowana w doskonały sposób. Dzięki niej można mieć pewność suplementacji diety najlepszymi produktami, które będą oddziaływać na organizm w sposób holistyczny.  </figcaption>
			</figure> </div>
		<div class="col-sm-12 col-md-6  kupteraz">  <a href="#" class="text-decoration-none text-light"><h4 class="font-weight-bold text-uppercase pb-2 pr-2 pt-2 pl-2 mt-5 mb-2 bg-footercolor"> KUP TERAZ <br> 25 ZŁ </h4>  </a> </div>
